...
import { IELTSSection } from "./ielts-section"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100">
        ...
        <div className="border-2 border-white p-8 rounded-xl">
          ...
          >
            ...
            <p className="leading-relaxed text-lg tracking-wide hover:scale-105 transition-transform duration-300">
              Master the IELTS exam with our expert-led course designed to help you achieve
              your desired band score. Whether you’re preparing for higher education, work,
              or immigration, our comprehensive training ensures you gain the skills and
              confidence needed to excel in all four sections:
            </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Complete coverage of Reading, Writing, Speaking & Listening",
              },
              {
                icon: <Target className="w-8 h-8 text-blue-600" />,
                title: "Target-Oriented",
                description: "Structured approach to achieve your desired band score",
              },
            ].map((item, index) => (
              <Card
                key={index}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6 bg-white/80 backdrop-blur-sm p-8 rounded-xl">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    "Immigration Advantage: Essential for PR applications",
                    "Career Growth: Opens doors to international job markets",
              ...
              <div className="space-y-6 bg-white/80 backdrop-blur-sm p-8 rounded-xl">
                ...
                <ul className="space-y-4">
                  {[
                    "Expert Trainers: Learn from IELTS specialists",
                    "Proven Track Record: Consistent 7+ band achievers",
                    "Practice Tests: Regular mock tests under exam conditions",
                    "Small Batches: Personalized attention guaranteed",
                    "Study Material: Comprehensive resources provided",
                  ].map((reason, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-blue-600 flex-shrink-0" />
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6 text-2xl text-blue-600 mb-9">
          Start your IELTS journey with JG Language Academy and achieve your dream score effortlessly!
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6 bg-white shadow-xl rounded-2xl p-10">
          ...
          <h2 className="text-3xl font-bold text-blue-900">Ready to Start Your IELTS Journey?</h2>
